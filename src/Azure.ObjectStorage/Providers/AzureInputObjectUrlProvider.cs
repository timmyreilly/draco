...
{
    public class AzureInputObjectUrlProvider : IInputObjectUrlProvider
    {
        ...
        public AzureInputObjectUrlProvider(
            IOptionsSnapshot<AzureObjectStorageOptions<AzureInputObjectUrlProvider>> storageOptionsSnapshot,
            IOptionsSnapshot<ObjectUrlOptions<AzureInputObjectUrlProvider>> urlOptionsSnapshot,
        ...
        public async Task<ObjectUrl> GetReadableUrlAsync(ObjectUrlRequest urlRequest)
        {
            ...
            return await this.urlProvider.GetObjectUrlAsync(
                new AzureObjectUrlRequest
                {
